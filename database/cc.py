...
def save_to_database(country_info):
    ...
    try:
        ...
        # Insert country's information into the database
        query = "INSERT INTO countries (country, capital) VALUES (%s, %s)"
        cursor.execute(query, (country_info["country_name"], country_info["capital_city"]))
